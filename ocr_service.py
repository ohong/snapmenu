...
async def process_menu_ocr(image_file):
    """Process menu image using Mistral OCR on Koyeb"""
    try:
        ...
        if not endpoint or not api_key:
            raise ValueError("Missing MISTRAL_OCR_ENDPOINT or KOYEB_API_KEY environment variables")
        ...
        payload = {
            "image": image_base64,
            "prompt": "Extract all text from this restaurant menu. Include dish names, descriptions, and prices. Maintain the original structure and formatting."
        }
